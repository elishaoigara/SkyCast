...
function Weather({ data }) {
  ...
  return (
    <div className={`card weather-card text-white shadow p-4 my-4 ${bgClass}`}>
      <h2 className="mb-3 text-center">{name}, {sys.country}</h2>

      <h4 className="text-capitalize mb-4 text-center">
      ...
      <div className="row text-center gy-3">
        <div className="col-12 col-md-4">
          <p className="fs-6 fs-md-5">
            🌡️ <strong>Temperature:</strong> {main.temp}°C
          </p>
        </div>
        <div className="col-12 col-md-4">
          <p className="fs-6 fs-md-5">
        ...
        <div className="col-12 col-md-4">
          <p className="fs-6 fs-md-5">
            🌬️ <strong>Wind Speed:</strong> {wind.speed} m/s
          </p>
        </div>
      </div>
